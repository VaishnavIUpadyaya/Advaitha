...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-[#976f4c]">
      <div className="bg-[#eceadd] p-10 rounded-xl shadow-xl w-full max-w-3xl">
        ...
        <div className="mt-8 items-center flex justify-center">
          <button
            onClick={saveChanges}
            className=" bg-[#a4896a] items-center flex justify-center rounded-xl  hover:bg-[#796855] text-white px-6 py-2"
          >
            Save Changes
          </button>
        </div>
