      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center">
          <button 
            ...
            className="px-6 py-2 rounded-full border border-[#d4846d] text-white/90 text-[10px] font-bold uppercase tracking-widest hover:bg-[#d4846d] hover:text-[#0f1115] transition-all duration-300"
          >
            Support
          </button>
        </div>
